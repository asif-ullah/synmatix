...
public class Mobile_adpater extends RecyclerView.Adapter<Mobile_adpater.MyViewHolder> {
    Context context;
    List<Strinh_subpkges> list = new ArrayList<>();

    public Mobile_adpater(List<Strinh_subpkges> strinh_subpkges, Context context) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(context, Packages_detail.class);
