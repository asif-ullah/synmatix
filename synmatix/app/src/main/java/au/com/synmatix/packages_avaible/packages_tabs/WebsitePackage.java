...
import au.com.synmatix.packages_avaible.adapters.Web_adapter;

/**
 * Created by user on 3/28/18.
 */

public class WebsitePackage extends Fragment {
    DbHelper db;
    Cursor cur;
...
// Inflate the layout for this fragment
        ...
        recyclerView_pkgs = (RecyclerView) view.findViewById(R.id.rv_website);
       // Seo_packages();
        return view;
    }
...
// open database
        ...
        try {
            while (cur.moveToNext()) {
                ...
                Web_adapter adapter = new Web_adapter(strinh_subpkges, getContext());
