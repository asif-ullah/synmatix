...
import au.com.synmatix.packages_avaible.adapters.Seo_adapter;
...
public class Seo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView_pkgs = (RecyclerView) view.findViewById(R.id.rv_seo);
        Seo_packages();
        return view;
    }
...
// open database
        ...
        try {
            while (cur.moveToNext()) {
                ...
                Seo_adapter adapter = new Seo_adapter(strinh_subpkges, getContext());
