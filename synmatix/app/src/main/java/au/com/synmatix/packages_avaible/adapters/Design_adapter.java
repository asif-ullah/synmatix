...
public class Design_adapter extends RecyclerView.Adapter<Design_adapter.MyViewHolder> {
    Context context;
    List<Strinh_subpkges> list = new ArrayList<>();

    public Design_adapter(List<Strinh_subpkges> strinh_subpkges, Context context) {
